...
import image4 from '@/images/photos/image-1.png'
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Senior FullStack Engineer based in Bangladesh.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Ruhul Amin, a Senior FullStack Engineer based in Bangladesh.
            Building Scalable Web Applications with Expertise in Full-Stack and
            AI Technologies Senior FullStack Engineer with advanced skills in
            Python, Node.js, React.js, Next.js, and TypeScript. Experienced in
            integrating OpenAI, ChatGPT, and Smart Editor Cursor to create
            innovative AI-powered solutions. Proficient in database management
            (MySQL, MongoDB) and deploying applications on cloud platforms like
            AWS, Firebase, and Supabase. Passionate about crafting efficient,
            scalable systems that elevate user experiences and deliver business
            value..
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/avastamin"
